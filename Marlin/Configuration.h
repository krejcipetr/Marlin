...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 30, 30, 30, 40 } // (mm) Left, Front, Right, Back insets
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_IDLE_SLEEP 300 // (secs) Turn off the TFT backlight if set (5min)
