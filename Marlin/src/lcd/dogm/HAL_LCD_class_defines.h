...
extern u8g_dev_t u8g_dev_tft_auto_upscale_from_128x64;

class U8GLIB_TFT_AUTO_UPSCALE_FROM_128X64 : public U8GLIB {
public:
  U8GLIB_TFT_AUTO_UPSCALE_FROM_128X64(uint8_t cs, uint8_t rs, uint8_t reset = U8G_PIN_NONE)
  : U8GLIB(&u8g_dev_tft_auto_upscale_from_128x64, cs, rs, reset)
  { }
};
