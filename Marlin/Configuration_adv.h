...
#define AUTOTEMP
#if ENABLED(AUTOTEMP)
  #define AUTOTEMP_OLDWEIGHT    0.75  // Factor used to weight previous readings (0.0 < value < 1.0)
...
#define DEFAULT_MINTRAVELFEEDRATE    20

// (mm/s. °/s for rotational-only moves) Minimum travel feedrate. Set with M205 T.
...
#define MINIMUM_PLANNER_SPEED 0.5 // (mm/s)
 ...
 */
   ...
   */
  // #define DISPLAY_SLEEP_MINUTES 5  // (minutes) Timeout before turning off the screen. Set with M255 S.
