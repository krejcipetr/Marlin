...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN PE5                  // Override the default pin if needed
...
#define DEFAULT_MINIMUMFEEDRATE       1     // (mm/s) Minimum feedrate. Set with M205 S.
#define DEFAULT_MINTRAVELFEEDRATE     1    // (mm/s) Minimum travel feedrate. Set with M205 T.
...
#define MINIMUM_PLANNER_SPEED 1 // (mm/s)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 60*60, 60*60, 7*60, 1*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MILLIMETER_UNITS 10      // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps
 ...
 */
  ...
  //#define MESH_MAX_X 255
  //#define MESH_MAX_Y 255
#endif
...
//  #define SOFTWARE_DRIVER_ENABLE
   ...
   * To manage over-temp Marlin can decrease the driv#define Z2_ENABLE_PIN E1_ENABLE_PIN
#define Z2_STEP_PIN E1_STEP_PIN
#define Z2_DIR_PIN E1_DIR_PIN
   * er current until the error condition clears.
 ...
 *     L6470_CHAIN_SS_PIN#define Z2_ENABLE_PIN E1_ENABLE_PIN
#define Z2_STEP_PIN E1_STEP_PIN
#define Z2_DIR_PIN E1_DIR_PIN
 *
...
//#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Home & Aktivace UBL"
  #define USER_GCODE_1 "G28\nG29 P3\nM420 S1\nG27"

  #define USER_DESC_2 "Kontrola vychozi pozice"
  #define USER_GCODE_2 "G28\nG29 P3\nM420 S1\nG1 Z20\n G1 X150 Y150 Z1.75"

  #define USER_DESC_3 "Kontrola vice mista"
  #define USER_GCODE_3 "G29 P6 C0.1\nG1 Z1.75"

  #define USER_DESC_4 "Kontrola mene mista"
...
//#define MECHANICAL_GANTRY_CALIBRATION
  ...
  #define GANTRY_CALIBRATION_FEEDRATE         500     // #define Z2_ENABLE_PIN E1_ENABLE_PIN
#define Z2_STEP_PIN E1_STEP_PIN
#define Z2_DIR_PIN E1_DIR_PIN
Feedrate for correction move
